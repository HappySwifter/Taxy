...
- (NSString *) stringWithHumanizedTimeDifference:(NSDateHumanizedType) humanizedType withFullString:(BOOL) fullStrings
{
    ...
    weekString   = [NSString stringWithFormat:@"%d%@", weeksDiff, NSLocalizedStringFromTable(@"нед.", translation_table, @"")];
    dayString    = [NSString stringWithFormat:@"%d%@", daysDiff, NSLocalizedStringFromTable(@"дн.", translation_table, @"")];
    hourString   = [NSString stringWithFormat:@"%d%@", hoursDiff, NSLocalizedStringFromTable(@"час.", translation_table, @"")];
    minuteString = [NSString stringWithFormat:@"%d%@", minutesDiff, NSLocalizedStringFromTable(@"мин.", translation_table, @"")];
    secondString = [NSString stringWithFormat:@"%d%@", secondsDiff, NSLocalizedStringFromTable(@"сек.", translation_table, @"")];
    ...
    full_weekString   = [NSString stringWithFormat:@"%d %@%@", weeksDiff,
                         NSLocalizedStringFromTable(@"нед.", translation_table, @""),
                         (weeksDiff == 1) ? @"" : @"s"];
    full_dayString    = [NSString stringWithFormat:@"%d %@%@", daysDiff,
                         NSLocalizedStringFromTable(@"дн.", translation_table, @""),
                         (daysDiff == 1) ? @"" : @"s"];
    full_hourString   = [NSString stringWithFormat:@"%d %@%@", hoursDiff,
                         NSLocalizedStringFromTable(@"час.", translation_table, @""),
                         (hoursDiff == 1) ? @"" : @"s"];
    full_minuteString = [NSString stringWithFormat:@"%d %@%@", minutesDiff,
                         NSLocalizedStringFromTable(@"мин.", translation_table, @""),
                         (minutesDiff == 1) ? @"" : @"s"];
    full_secondString = [NSString stringWithFormat:@"%d %@%@", secondsDiff,
                         NSLocalizedStringFromTable(@"сек.", translation_table, @""),
                         (secondsDiff == 1) ? @"" : @"s"];
